                            ...
                            <tbody>
                                @foreach ($documents as $document)
                                    <tr>
                                        ...
                                        <td class="py-2">{{ $document->acceptance ? $document->acceptance->accepted_at : 'Not Accepted Yet' }}</td>
                                        <td class="py-2">
                                        ...
                                        <td class="py-2">{{ $document->acceptance ? $document->acceptance->updated_at : 'Not Released Yet' }}</td>
                                        <td class="py-2">
