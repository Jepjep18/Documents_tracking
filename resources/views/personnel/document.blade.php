                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 text-left">
                                                    @if ($document->acceptance && $document->acceptance->reuploaded_file_name)
                                                        <a href="{{ route('document.download', $document->acceptance->reuploaded_file_name) }}"
                                                            class="text-blue-600 hover:text-blue-800 font-semibold">{{ $document->acceptance->reuploaded_file_name }}</a>
                                                    @else
                                                        No Re-uploaded File
                                                    @endif
                                                </td>
